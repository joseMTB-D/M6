...
public class programa {
	public static void main (String[]args) {
		...
		*/
		/*
		System.out.println("Inserta el numero de alumnes:");
		int al=scan.nextInt();
		scan.nextLine();	
		
		String [] alumnes = new String[al];
		for(int i =0;i<alumnes.length;i++) {
			System.out.println("Inserta el nom del alumne "+(i+1));
			alumnes[i]=scan.nextLine();	
		}
		int c=0;
		while(c<(al)){
			System.out.println("L'alumne numero "+(c+1)+" Es diu: "+alumnes[c]);
		 	c+=1;
		}
		*/
